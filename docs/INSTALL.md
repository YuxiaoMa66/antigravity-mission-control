...
`@latest` follows the stable npm release. Pin `@0.3.1` when reproducibility matters; the npm bootstrapper then resolves the matching verified Git tag internally.
